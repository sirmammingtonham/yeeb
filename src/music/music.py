...
class Music(commands.Cog):
    ...
    async def connect(self, ctx: commands.Context):
        ...
        try:
            ...
            return await msg.edit(content=":notes: Not in a voice channel nerd. Join one.")
    ...
    async def seek(self, ctx: commands.Context, seconds: int):
        ...
        if player.is_playing():
            ...
            self.bot.dispatch("dismusic_player_seek",
                              player, old_position, position)
    ...
    @commands.command(aliases=["np", "current", "currentsong", "playing", "what\"sthisfire", "whatsthisfire"])
    @voice_channel_player()
